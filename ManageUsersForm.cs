...
namespace Gr8Food
{
    public partial class ManageUsersForm : Form
    {
        ...
        private void BuildUI()
        {
            ...
            _txtFullName.Location = new Point(285, 72);
            _txtFullName.Size = new Size(150, 22);
            this.Controls.Add(_txtFullName);

            AddLabel("Phone", 445, 75, bodyFont);
            _txtPhone = new TextBox();
            _txtPhone.Location = new Point(490, 72);
            _txtPhone.Size = new Size(110, 22);
            this.Controls.Add(_txtPhone);

            AddLabel("Role", 610, 75, bodyFont);
            _cmbRole = new ComboBox();
            _cmbRole.Location = new Point(650, 72);
            _cmbRole.Size = new Size(120, 22);
            ...
            _txtUsername.Location = new Point(285, 107);
            _txtUsername.Size = new Size(170, 22);
            this.Controls.Add(_txtUsername);

            AddLabel("Password", 465, 110, bodyFont);
            _txtPassword = new TextBox();
            _txtPassword.Location = new Point(520, 107);
            _txtPassword.Size = new Size(130, 22);
            ...
            _dgvUsers.Size = new Size(640, 255);
            _dgvUsers.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells;
        ...
        private void BtnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (um.HasRelatedRecords(_selectedUserId))
            {
                MessageBox.Show(
                    "This user cannot be deleted because they have existing orders, wallet transactions, " +
                    "or feedback records. Consider changing their role instead.",
