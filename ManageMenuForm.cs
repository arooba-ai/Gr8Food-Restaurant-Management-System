...
namespace Gr8Food
{
    public partial class ManageMenuForm : Form
    {
        ...
        private void BuildUI()
        {
            ...
            _txtMenuName.Location = new Point(285, 72);
            _txtMenuName.Size = new Size(140, 22);
            ...
            lblCategory.Location = new Point(435, 75);
            this.Controls.Add(lblCategory);

            _cmbCategory = new ComboBox();
            _cmbCategory.Location = new Point(495, 72);
            _cmbCategory.Size = new Size(120, 22);
            ...
            _txtPrice.Location = new Point(285, 105);
            _txtPrice.Size = new Size(90, 22);
            ...
            lblAvailability.Location = new Point(435, 108);
            this.Controls.Add(lblAvailability);

            _cmbAvailability = new ComboBox();
            _cmbAvailability.Location = new Point(495, 105);
            _cmbAvailability.Size = new Size(140, 22);
            ...
            btnAdd.Text = "Add";
            btnAdd.Location = new Point(650, 72);
            ...
            btnUpdate.Location = new Point(650, 105);
            ...
            btnDelete.Location = new Point(720, 72);
            ...
            _dgvMenu.Size = new Size(640, 300);
            _dgvMenu.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells;
        ...
        private void BtnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Unable to add the menu item. Please try again.");
            }
        ...
        private void ClearFields()
        {
            ...
            _txtPrice.Text = "";
            _cmbAvailability.SelectedIndex = -1;
        }
        ...
        private void BtnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (mm.IsMenuItemReferenced(_selectedMenuId))
            {
                MessageBox.Show(
                    "This menu item cannot be deleted because it is associated with existing orders. " +
                    "You can mark it as Not Available instead.",
